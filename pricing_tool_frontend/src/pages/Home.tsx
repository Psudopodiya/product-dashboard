...
export default function HomePage() {
  ...
  // return (
  //   <div className="min-h-screen py-12 flex flex-col justify-between">
  //     {/* Logo */}
  //     <div className="flex justify-center mb-6">
  //       <img src={logo} alt="BCGX Logo" className="h-10" />
  //     </div>

  //     {/* Title */}
  //     <div className="flex flex-col items-center gap-5">
  //       <h1 className="text-4xl font-bold mb-3">Price Optimization Tool</h1>
  ...
  //             key={index}
  //             onClick={() => navigate(card.link)}
  //             className="w-full sm:w-80 cursor-pointer hover:shadow-lg hover:scale-105 transition-transform ease-in-out duration-300"
  //           >
  //             <CardHeader>
  //               <div>
  //                 <img src={card.icon} alt={card.title} className="h-20" />
  //               </div>
  //             </CardHeader>
  //             <CardContent className="flex flex-col gap-2 h-full items-start">
